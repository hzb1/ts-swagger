<template>
  <div>
    <!--    <h2>Swagger 调试器 Vue Demo</h2>-->

    <!--    <div v-if="loadingSwagger">加载中...</div>-->
    ...
    <header class="navbar">
      ...
      <div>
        ...
        <!--          style="width: 300px"-->
        <!--        />-->
        <select v-model="ip" name="ip" id="ip-select" style="width: 160px" @change="loadSwagger()">
          <option v-for="item in ipOptions" :key="item.value" :value="item.value">
            {{ item.label }}
          </option>
        </select>
